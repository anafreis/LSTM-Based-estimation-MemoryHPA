...
subplot(1,3,1)
colorOrder = get(gca, 'ColorOrder');
LSTMDPANN_memlss = semilogy(EbN0dB, memoryless_LSTM_DPA_NN_ERR,'-o','MarkerFaceColor',colorOrder(1,:),'color',colorOrder(1,:),'MarkerSize',8,'LineWidth',2);
hold on
LSTMDPATA_memlss = semilogy(EbN0dB, memoryless_LSTM_DPA_TA_ERR,'-^','MarkerFaceColor',colorOrder(2,:),'color',colorOrder(2,:),'MarkerSize',8,'LineWidth',2);
DPALSTMNN_memlss = semilogy(EbN0dB, memoryless_DPA_LSTM_NN_ERR,'-h','MarkerFaceColor',colorOrder(3,:),'color',colorOrder(3,:),'MarkerSize',8,'LineWidth',2);
grid on
set(0,'defaulttextinterpreter','latex')
set(groot,'defaultAxesTickLabelInterpreter','latex')
hAxes.TickLabelInterprete = 'latex';
...
subplot(1,3,3)
colorOrder = get(gca, 'ColorOrder');
LSTMDPANN_memory_Comp = semilogy(EbN0dB,memory_Compensated_LSTM_DPA_NN_ERR ,'-o','MarkerFaceColor',colorOrder(1,:),'color',colorOrder(1,:),'MarkerSize',8,'LineWidth',2);
hold on;
LSTMDPATA_memory_Comp = semilogy(EbN0dB,memory_Compensated_LSTM_DPA_TA_ERR ,'-^','MarkerFaceColor',colorOrder(2,:),'color',colorOrder(2,:),'MarkerSize',8,'LineWidth',2);
DPALSTMNN_memory_Comp = semilogy(EbN0dB,memory_Compensated_DPA_LSTM_NN_ERR,'-h','MarkerFaceColor',colorOrder(3,:),'color',colorOrder(3,:),'MarkerSize',8,'LineWidth',2);
grid on
set(0,'defaulttextinterpreter','latex')
set(groot,'defaultAxesTickLabelInterpreter','latex')
hAxes.TickLabelInterprete = 'latex';
